...
if place <= 10 and scores >= 290:
  print('Поздравляю, вы поступили на бюджет и будете получать стипендию.')
elif place <= 10 and scores < 290:
  print('Поздравляю ты поступил, но не будешь получать стипендию.')
else:
